...
// required by export
#if BOOST_VERSION < 103500
#define BOOST_ARCHIVE_CUSTOM_OARCHIVE_TYPES cryptonote::portable_oarchive
#else
BOOST_SERIALIZATION_REGISTER_ARCHIVE(cryptonote::portable_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(cryptonote::polymorphic_portable_oarchive)
#endif
...
namespace boost { namespace archive {
	...
	template class basic_binary_oarchive<cryptonote::portable_oarchive>;

	template class basic_binary_oprimitive<
		cryptonote::portable_oarchive
	#if BOOST_VERSION < 103400
		, std::ostream
	#else
		, std::ostream::char_type
...
#if BOOST_VERSION < 104000
	template class detail::archive_pointer_oserializer<cryptonote::portable_oarchive>;
#else
	template class detail::archive_serializer_map<cryptonote::portable_oarchive>;
	//template class detail::archive_serializer_map<cryptonote::polymorphic_portable_oarchive>;
#endif
